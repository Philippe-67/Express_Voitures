...
namespace Express_Voitures.Controllers
{
    public class ReparationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DatePEC,Description,DateDisponibilite,VoitureId")] Reparation reparation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DatePEC,Description,DateDisponibilite,VoitureId")] Reparation reparation)
        {
            if (id != reparation.Id)
            {
                return NotFound();
