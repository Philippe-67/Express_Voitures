...
namespace Express_Voitures.Controllers
{
    public class VoituresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Annee,Marque,Modele,Finition,DateAchat,DateVente,PrixAchat,PrixVente")] Voiture voiture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Annee,Marque,Modele,Finition,DateAchat,DateVente,PrixAchat,PrixVente")] Voiture voiture)
        {
            if (id != voiture.Id)
            {
                return NotFound();
